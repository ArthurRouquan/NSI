...
!!! info "Liens"
    * Document Réponse : [:fontawesome-solid-link: Notebook Capytale 91f2-1517386](https://capytale2.ac-paris.fr/web/c/91f2-1517386)
...
??? question "Questions 2"
    ...
    3. Réaliser le plan du jeu de manière **collaborative** ! 
        ...
        Le lien du diagramme partagé est [disponible ici](https://drive.google.com/file/d/1Vac8FOCE3SIiab5eow_QTlqPPE0gFgbG/view?usp=sharing). Il faudra alors vous connectez à votre compte Google. Veuillez respecter le **code couleur** (copier-coller simplement les nœuds du diagramme) !
